...
const HomeNight = () => {
  ...
  return (
    <div className='relative flex flex-col items-center justify-center h-full'>
      <Image className='absolute top-[12%] left-[15%]' src="/images/night_animals/illust_01_dark.svg" alt="강아지들" width={60} height={80} />
      <Image className='absolute top-[22%] right-[9%]' src="/images/night_animals/illust_02_dark.svg" alt="강아지들" width={74} height={70} />
      <Image className='slideLeft absolute top-[40%] left-[40%]' src="/images/night_animals/illust_03_dark.svg" alt="강아지들" width={80} height={60} />
      ...
      >
        ...
        <SwiperSlide style={{width: 'auto', userSelect: 'none'}}>
          <Image className='my-10' src="/images/night_animals/illust_07_dark.svg" alt="강아지들" width={200} height={100} style={{marginLeft: '-6px'}} />
        </SwiperSlide>
      </Swiper>
