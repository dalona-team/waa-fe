    ...
    <div className="relative flex flex-col items-center justify-center h-full overflow-y-auto invisible-scroll">
      ...
      <div className="flex-1 flex flex-col justify-center items-center">
        <Image
          ...
          src="/images/day_animals/illust_01.svg"
          alt="강아지들"
          width={60}
          height={80}
        />
        <Image
          ...
          src="/images/day_animals/illust_02.svg"
          alt="강아지들"
          width={74}
          height={70}
        />
        <Image
          ...
          src="/images/day_animals/illust_03.svg"
          alt="강아지들"
          width={80}
          height={60}
        />
      ...
      <div className="flex-1 w-full overflow-hidden flex flex-col items-center gap-4">
        ...
        >
          {cardList.map((card, index) => (
            ...
            >
              <div className="relative w-40 h-[168px] font-gangwon leading-tight pl-5 pr-5 pt-2.5 pb-4 bg-white rounded-xl flex flex-col justify-center text-lg font-normal text-left">
                {card.imageSrc ? (
                  <div
          ...
          <SwiperSlide style={{ width: 'auto', userSelect: 'none' }}>
            <Image
              priority
              className="my-10"
              src="/images/day_animals/illust_07.svg"
              alt="강아지들"
              width={200}
              height={100}
